...
```{r}
conjoint_data <- read.csv(file = paste0(root_path,"conjoint_data.csv"),sep = ";",header = TRUE)
conjoint_data$ScoreVideo <- conjoint_data$ScoreVideo %>% gsub(pattern = ",",replacement = ".",.)
conjoint_data$ScoreChannel <- conjoint_data$ScoreChannel %>% gsub(pattern = ",",replacement = ".",.)
conjoint_data$LikeDislikeScore <- conjoint_data$LikeDislikeScore %>% gsub(pattern = ",",replacement = ".",.)
conjoint_data$SentimentScore <- conjoint_data$SentimentScore %>% gsub(pattern = ",",replacement = ".",.)
conjoint_data$ScoreVideo <- as.numeric(conjoint_data$ScoreVideo)
conjoint_data$ScoreChannel <- as.numeric(conjoint_data$ScoreChannel)
conjoint_data$LikeDislikeScore <- as.numeric(conjoint_data$LikeDislikeScore)
conjoint_data$SentimentScore <- as.numeric(conjoint_data$SentimentScore)

regression_multiple <- lm(~ScoreVideo+ScoreChannel+LikeDislikeScore+SentimentScore,data = conjoint_data)
conjoint_data
...
save(json_list,df_language_fulltitle,df_language_fulltitle_textcat, sorted_json_list3,df_json_metadata, df_json_metadata_enrich, res.pcamix,res.pca,videos_words,file="Permanentdata")
